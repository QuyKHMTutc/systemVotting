  ...
  return (
    <div className="min-h-screen pb-12">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* Search & Filters */}
        <div className="glass-panel p-5 rounded-2xl mb-10 border border-white/10">
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex flex-col sm:flex-row gap-4 flex-1">
              <div className="relative flex-1 group/input">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40 group-focus-within/input:text-indigo-400 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {(pollPage?.content ?? []).length === 0 ? (
              <div className="col-span-full glass-panel py-20 text-center rounded-2xl border border-dashed border-white/20">
