                ...
                <div className="glass-panel p-8 sm:p-12 rounded-3xl border border-slate-200 dark:border-white/10 shadow-xl dark:shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-6 mb-12 border-b border-slate-200 dark:border-white/10 pb-8">
                            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-500/20 to-indigo-500/20 flex items-center justify-center border border-slate-200 dark:border-white/10 shrink-0">
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 dark:text-white/50 font-medium">{t('termsPage.lastUpdated')}</p>
                            </div>
                        </div>
                            ...
                            {sections.map((s, i) => (
                                <section key={s}>
                                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-3">
                                        <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-100 dark:bg-white/5 text-pink-600 dark:text-pink-400 text-sm font-bold border border-slate-200 dark:border-white/5 shrink-0">
                                            {i + 1}
                                        </span>
                                        {t(`termsPage.${s}Title`)}
                                    </h3>
                                    <p className="md:pl-11">{t(`termsPage.${s}Desc`)}</p>
                                </section>
                            ))}
                        </div>
                    </div>
